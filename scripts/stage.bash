...
git remote add origin https://github.com/munair/www-dreadcapoeira-com.git
...
heroku apps:destroy staging-dreadcapoeira-com --confirm staging-dreadcapoeira-com
heroku apps:create staging-dreadcapoeira-com
heroku domains:add staging.dreadcapoeira.com --app staging-dreadcapoeira-com
heroku git:remote -a staging-dreadcapoeira-com -r staging-heroku
